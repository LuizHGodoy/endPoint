import { type EnvironmentVariable, globalEnvironmentAtom } from "@/lib/atoms";
...
export function GlobalEnvironmentEditor() {
  const [globalEnv, setGlobalEnv] = useAtom(globalEnvironmentAtom);
  ...
  const addVariable = () => {
    ...
    setGlobalEnv({
      ...globalEnv,
      variables: [...globalEnv.variables, newVariable],
    });
  ...
  const updateVariable = (
    ...
    setGlobalEnv({
      ...globalEnv,
      variables: globalEnv.variables.map((v) =>
  ...
  const deleteVariable = (variableId: string) => {
    setGlobalEnv({
      ...globalEnv,
      variables: globalEnv.variables.filter((v) => v.id !== variableId),
    });
  };
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-medium">Variáveis Globais</h3>
      ...
      <ScrollArea className="h-[400px] pr-4">
        <div className="space-y-4">
          {globalEnv.variables.map((variable) => (
